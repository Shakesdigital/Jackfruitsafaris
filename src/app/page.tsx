...
export default function Home() {
  return (
    <>
        ...
        <div className="relative mx-auto flex min-h-[86vh] max-w-7xl items-center px-4 py-16 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <p className="inline-flex items-center gap-2 rounded-full bg-white/12 px-4 py-2 text-sm font-black uppercase tracking-[0.2em] text-[#f5bf2f] ring-1 ring-white/20">
              <BadgeCheck size={17} />
              Local safari experts from Jinja
            </p>
            <h1 className="mt-6 max-w-4xl text-5xl font-black leading-[0.98] sm:text-7xl">
              Explore Uganda With Local Safari Experts
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-white/84 sm:text-xl">
              Private Uganda safaris, gorilla trekking, Jinja adventures,
              cultural experiences, and reliable airport transfers planned by
              Jackfruit Safaris Uganda from Jinja.
            </p>
      ...
      <Section
        eyebrow="Why Uganda"
        title="One compact country, many safari worlds"
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_0.85fr]">
          <div className="rounded-[8px] bg-[#143c2d] p-8 text-white sm:p-10">
            <p className="text-xl leading-9 text-white/82">
              Jackfruit Safaris helps you experience Uganda smoothly, with local
              guides who understand the roads, parks, permits, lodges, and small
              details that make a trip feel effortless.
            </p>
          ...
          {experiences.map((experience) => {
            ...
            return (
              ...
              >
                ...
                />
                <div className="p-5">
                  <Icon className="text-[#2d6f55]" size={24} />
        ...
        <div className="grid gap-8 rounded-[8px] bg-[#f5bf2f] p-8 sm:p-10 lg:grid-cols-[1fr_0.6fr] lg:items-center">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-lg leading-8 text-[#27382b]">
              Jackfruit Safaris will recommend the best route and quote, with
              clear inclusions, exclusions, and items that need live checking.
            </p>
          </div>
