        ...
        {rows.map((row, index) => (
          <div key={index} className="flex flex-col gap-2 sm:flex-row sm:gap-2">
            ...
            <button
              ...
              className="w-full sm:w-auto min-h-[44px] rounded-md border border-gray-300 px-3 py-3 text-sm hover:bg-gray-50 sm:self-start focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-accent)]"
        ...
        {rows.map((row, index) => (
          <div key={index} className="flex flex-col gap-2 sm:grid sm:grid-cols-[0.5fr_1fr_auto] sm:gap-2">
            ...
            <button
              type="button"
              onClick={() => setRows(rows.filter((_, rowIndex) => rowIndex !== index))}
              className="self-start min-h-[44px] rounded-md border border-gray-300 px-3 py-3 text-sm hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-accent)]"
