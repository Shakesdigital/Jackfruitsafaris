...
insert into public.pages (
  ...
  ('home', 'Home', 'Main Jackfruit Safaris landing page with hero, trust items, safari packages, experiences, reviews, guide links, and quote CTA.', 'published', 'Jackfruit Safaris | Uganda Safaris and Gorilla Trekking', 'Plan private Uganda safaris, gorilla trekking, Jinja adventures, cultural experiences, and transfers with Jackfruit Safaris.'),
  ...
  ('reviews', 'Reviews', 'Guest review landing page with approved testimonials and trip proof.', 'published', 'Guest Reviews | Jackfruit Safaris', 'Read traveler reviews and trip feedback from guests who explored Uganda with Jackfruit Safaris.'),
  ('about', 'About', 'About page covering Jackfruit Safaris local roots, operating areas, guiding style, and service scope.', 'published', 'About Jackfruit Safaris', 'Learn about Jackfruit Safaris, a locally rooted tour company based in Jinja and planning safaris across Uganda.'),
...
insert into public.page_heroes (
  ...
  ('/', 'Local safari experts from Jinja', 'Explore Uganda With Local Safari Experts', 'Private Uganda safaris, gorilla trekking, Jinja adventures, cultural experiences, and reliable airport transfers planned by Jackfruit Safaris from Jinja.', 'https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?auto=format&fit=crop&w=2200&q=82', '{}'::jsonb, 'published'),
  ('/about', 'About Jackfruit Safaris', 'Local roots, practical planning, and warm guest care', 'Jackfruit Safaris is a registered tour company based in Jinja, one of Uganda''s most exciting travel hubs and the adventure capital of East Africa.', null, jsonb_build_object(
